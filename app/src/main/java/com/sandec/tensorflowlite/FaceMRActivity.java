...
import com.sandec.predictivemodels.Classification;
import com.sandec.predictivemodels.TensorFlowClassifier;

public class FaceMRActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_facemr);
            ...
            public void run() {
                try {
                    classifier=TensorFlowClassifier.create(getAssets(), "CNN",
                            "opt_em_convnet_5000.pb", "labels_faceemr.txt", PIXEL_WIDTH,

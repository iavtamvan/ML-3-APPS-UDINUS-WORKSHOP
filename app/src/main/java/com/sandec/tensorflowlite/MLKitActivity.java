...
public class MLKitActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
     ...
     */
    private static final String LABEL_PATH = "labels_mlkit.txt";
    /**
